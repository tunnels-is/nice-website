...
var STORE = {
	...
	Content: {
		...
		Home: {
			...
			Banner: {
				Title: "Made by us, for you.",
				Subtitle: "Cross-Platform, lightweight, portable, multi-network vpn",
				Img1: "https://raw.githubusercontent.com/tunnels-is/media/master/v3/temp/W1.png",
				Img2: "https://raw.githubusercontent.com/tunnels-is/media/master/v3/temp/W1.png",
				Img3: "https://raw.githubusercontent.com/tunnels-is/media/master/v3/temp/W1.png",
			},

			TriForce: {
				Content1: "50MB on disk",
				Img1: "https://raw.githubusercontent.com/tunnels-is/media/master/v3/temp/clean-settings.png",
				Content2: "200MB of Memory",
		...
		Features: {
			...
			SimpleAndScalableUserManagement: {
				Title: "Scalable User Management",
				Content: "Niceland offers group user management which can be controlled via and API or the application interface",
				Icon: LayersIcon,
			},
